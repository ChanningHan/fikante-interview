...
function strToInt(str) {
    ...
    while (endIndex >= 0 && (str[endIndex] < '0' || str[endIndex] > '9')) {
        endIndex--
    }
    ...
    let sum = 0
    const MAX_VALUE = Math.pow(2, 31) - (baseSymbol === 1 ? 1 : 0)
...
console.log(strToInt("3.14"));
console.log(strToInt("  -0012a42"));