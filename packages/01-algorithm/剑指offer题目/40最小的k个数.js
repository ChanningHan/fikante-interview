...
function test(fn) {
    const testArr = [
        ...
        },
        {
            ...
            k: 75,
            output: [
                0, 1, 1, 1, 4, 5, 3, 7, 7, 2, 7, 0, 5, 2, 1, 5, 2, 2, 6, 6, 2, 7, 7, 2, 3, 2, 1, 6,
                1, 2, 8, 8, 8, 9, 9, 8, 10, 22, 10, 11, 10, 10, 12, 13, 12, 12, 15, 18, 17, 16, 15,
                17, 19, 23, 19, 22, 19, 19, 20, 22, 22, 26, 31, 39, 27, 29, 32, 40, 26, 36, 27, 28,
                35, 33, 42,
            ],
        },
    ];
